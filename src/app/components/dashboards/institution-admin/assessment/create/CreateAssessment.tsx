...
export default function CreateAssessment({ mode = 'create', editAssessmentId }: Props) {
  return (
    <CreateEvaluationContainer
      mode={mode}
      editId={editAssessmentId} // ✅ THIS WAS MISSING
      config={{
        ...
        api: {
          create: assessmentApi.createAssessment,
          update: assessmentApi.updateAssessment,
          getById: assessmentApi.getAssessmentById, // ✅ required
          updateAudience: (id, batchIds) =>
            assessmentApi.updateAssessmentAudience(id, {
              batch_ids: batchIds,
            }),
          getQuestions: assessmentApi.getAssessmentQuestions,
          deleteQuestion: assessmentApi.deleteAssessmentQuestion,
          bulkUpload: (id, type, file) =>
            assessmentApi.bulkUploadQuestions(id, type as 'mcq' | 'coding', file),
        },
